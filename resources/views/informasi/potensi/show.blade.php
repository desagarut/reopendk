            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="row overflow-x">
                        <div class="col-md-3">
                            <p><img src="{{ asset($potensi->file_gambar) }}" width="100%"></p><br/>
                            <p><iframe width="100%" height="200" src="https://www.youtube.com/embed/{{ $potensi->url_video ?? null }}" title="Heavily modified Suzuki Omni in Dubai - 1/1" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                            </p>
                        </div>
                        <div class="col-md-9">
